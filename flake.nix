{
  description = "Small exercises to get you used to reading and writing secure Solidity smart contract code";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        apps = let
          soliditylings-app = {
            type = "app";
            program = "${soliditylings}/bin/soliditylings";
          };
        in {
          default = soliditylings-app;
          soliditylings = soliditylings-app;
        };
        packages = {
          inherit soliditylings;
          default = soliditylings;
        };
      });
}
