...
#Requires -Version 5
param($path = "$home/soliditylings")

Write-Host "Let's get you set up with SolidityLings!"
...
Write-Host "Cloning SolidityLings at $path"
...
$version = Invoke-WebRequest -UseBasicParsing https://api.github.com/repos/alysiahuggins/soliditylings_security/releases/latest`
...
Write-Host "Installing the 'soliditylings' executable..."
cargo install --force --path .
if (!(Get-Command soliditylings -ErrorAction SilentlyContinue)) {
...
Write-Host "All done! Navigate to $path and run 'soliditylings' to get started!"
